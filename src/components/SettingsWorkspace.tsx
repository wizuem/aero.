...
type SettingsWorkspaceProps = {
  ...
  proxyProvider: 'scramjet' | 'ultraviolet' | 'rammerhead';
  setProxyProvider: (value: 'scramjet' | 'ultraviolet' | 'rammerhead') => void;
  displayName: string;
...
export function SettingsWorkspace({ theme, setTheme, accent, setAccent, searchEngine, setSearchEngine, proxyProvider, setProxyProvider, displayName, setDisplayName, onSignIn }: SettingsWorkspaceProps) {
