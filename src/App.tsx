...
function initScramjet(): Promise<void> {
  ...
  scramjetReady = (async () => {
    ...
    const registration = await navigator.serviceWorker.register('/sw.js?v=7', { updateViaCache: 'none', scope: '/' });
