...
function initScramjet(): Promise<void> {
  ...
  scramjetReady = (async () => {
    ...
    if (!sessionStorage.getItem('scramjet-db-cleaned-v2')) {
      ...
      sessionStorage.setItem('scramjet-db-cleaned-v2', '1');
    }
